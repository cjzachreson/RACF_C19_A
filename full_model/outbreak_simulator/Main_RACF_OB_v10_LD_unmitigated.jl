...
function main_OB()
    ...
    #to maintain vector type for 1-element array
    push!(test_configurations, "lockdown_only")
    ...
    output_dir_L1 = pwd() * "\\output_v9_OB_LD_only\\$facility_label"
    ...
    for LD_j in lockdown_compliance_i  
        ...
        LD_label = "lockdown_compliance_$LD_str"
            ...
            if TC_i == "lockdown_only"
                ...
                #remove all interventions other than lockdown: 
                config_run.PPE_efficacy_relative_to_default = 0.0

                config_run.worker_case_isolation = false 
                config_run.resident_case_isolation = false
            ...
            # NOTE: lockdown efficacy must be leq (<=) case isolation efficacy or background contact
