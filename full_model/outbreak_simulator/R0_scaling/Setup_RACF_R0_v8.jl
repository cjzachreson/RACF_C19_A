# for R0 scaling, R0 is not a free parameter, but a model output. 
# this parameter will be removed, and replaced by the transmission rate, beta. 
...
function setup_run_default!(config::Config_T, data_dirname::String)
    ...
    config_str = "parameter variable name, human-readable description, value \n" # initialises an empty string 
        ...
        transmission_scaler = 0.01#default
    ...
    config_str = config_str*"\n"*"***\n"
        ...
        outbreak_control = false # R0 default  
    ...
    config_str = config_str*"\n"*"***testing probabilities*** \n"
        ...
        p_test_per_day = 0.0 #R0 default  # only used if testing is not sub-divided by agent type 
        ...
        #NOTE: this is now assigned from control parameter for test compliance. 
        p_test_per_day_workers_outbreak = 0.0 # R0 default 
