...
include("./Facility_Structure_R0_v8.jl")
...
function main_R0()
    ...
    for im in immunity_states 
        ...
        for i in 1:1#n_populations #facility indices
            ...
            output_dir_L1 = pwd() * "\\output_v8_R0_test_2\\$immunity_label\\$fac_label\\$n_label"
            ...
            output_fname = "$output_dir_L1\\beta_vs_R_est_net_init_test.csv"
