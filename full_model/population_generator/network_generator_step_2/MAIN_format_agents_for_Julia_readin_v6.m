...
input_date_label = '2023_09_27'
output_date_label = '2023_09_27'
...
input_dirname = [pop_gen_dir,'\facility_generator_step_1\output\',...
                 'agents_Hypothetical_facilities_v3\' input_date_label];

output_dirname = [pwd() '\agents_model_ready_v3\' output_date_label];

fac_list_dirname = [pop_gen_dir, ...
                    '\facility_generator_step_1\input\facility_characteristics'];
fac_list_fname = [fac_list_dirname, '\hypothetical_facility_characteristics_v3.csv'];
...
for i = 1:n_fac
    ...
    for r = 1:n_rooms
        ...
        workers_ids = [workers_ids; workers_g_r];
    end
